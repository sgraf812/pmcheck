...
\newcommand{\tmany}[1]{\texttt{Many} \; #1}
% GrdTree Gdt
\newcommand{\Gdt}{\ty{Gdt}}
\newcommand{\gdtguard}[2]{\texttt{Guard} \; #1 \; #2}
% CtTree Ctt
\newcommand{\Ctt}{\ty{Ctt}}
\newcommand{\cttdiv}[2]{\texttt{\lightning?} \; #1 \; #2}
\newcommand{\cttft}[2]{\texttt{FallThroughIf} \; #1 \; #2}
\newcommand{\cttref}[2]{\texttt{Refine} \; #1 \; #2}
% AnnTree Ant
\newcommand{\Ant}{\ty{Ant}}
\newcommand{\antdiv}[1]{\texttt{Diverges} \; #1}
\newcommand{\antred}[1]{\texttt{Inaccessible} \; #1}
% Compiling constraint trees
\newcommand{\cct}[1]{\texttt{cct} \; #1}
\newcommand{\cctg}[2]{\texttt{cctg} \; #1 \; #2}

\newcommand{\ctt}[2]{\texttt{ctt} \; #1 \; #2}
\newcommand{\pmc}[3]{\texttt{pmc} \; #1 \; #2 \; #3}
\newcommand{\plustheta}{\;\oplus\;}
\newcommand{\plusgamma}{\;\#\;}
\newcommand{\extdiv}{\cup_D}
\newcommand{\extcov}{\cup_C}
\newcommand{\extunc}{\cup_U}
