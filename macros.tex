...
% CtTree Ctt
\newcommand{\Ctt}{\ty{Ctt}}
\newcommand{\cttdiv}[2]{\texttt{DivergeIf} \; #1 \; #2}
...
\newcommand{\reprefs}[2]{\mathcal{R}(#1,#2)} % sequence of refinements of \unc
\newcommand{\ann}[2]{\mathcal{A}(#1,#2)}
\newcommand{\inh}[2]{\mathcal{V}(#1,#2)}

\newcommand{\plusdelta}{\oplus}
\newcommand{\plusgamma}{\;\#\;}
